...
let name = prompt('Ваше имя?');
    ...
    phone = prompt('Ваши контактные данные(Телефон)');
    email = prompt('Ваши контактные данные(Почта)');
    company = prompt('Компания, в которой вы работаете');

let info = 'Меня зовут ${name}. Мне ${age} лет. Я проживаю в городе ${city} и работаю в компании ${company}. Мои контактные данные: ${phone}, ${email}.';

let info2 = 'Меня зовут ' + name + '. Мне ' + age + ' лет. Я проживаю в городе ' + city + ' и работаю в компании ' + company + '. Мои контактные данные: ' + email + ', ' + phone + '.';
...
console.log(name, 'родился в', year); 
...
let g = prompt('Укажите число 1 0 или -3');

if (g > 0) console.log('Верно');
if (g <= 0) console.log('Неверно');
...
console.log(summ, diff, prod, div);

if (summ > 1) console.log(summ **2);
...
switch (o) {
    case 2:
        console.log('Число ' + o + ' попадает в первую четверть часа');
    break;
    case 20:
        console.log('Число ' + o + ' попадает во вторую четверть часа');
    break;
    case 40:
        console.log('Число ' + o + ' попадает в третью четверть часа');
    break;
    case 59:
        console.log('Число ' + o + ' попадает в четвертую четверть часа');
    break;
}
...
if (day >= 1 && day <= 10) { 
    console.log(' День ' + day + ' попал в первую декаду месяца');
} else if (day > 10 && day <= 20) {
    console.log(' День ' + day + ' попал во вторую декаду месяца');
}
else {
    console.log(' День ' + day + ' попал в третью декаду месяца');
}
